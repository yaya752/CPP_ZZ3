...
// Fin //-------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------- 23
/*TEST_CASE("Vecteur operations", "[Vecteur]") {
    // Initialisation de vecteurs pour les tests
    Vecteur vec1;
    vec1.ajouter(1);
    vec1.ajouter(2);
    ...
    SECTION("Concatenation") {
        ...
        REQUIRE(vec3.size() == vec1.size() + vec2.size());
        REQUIRE(vec3[0] == 1);
        REQUIRE(vec3[3] == 5);
    }

    SECTION("Produit scalaire") {
        int produitScalaire = vec1 * vec2;
        REQUIRE(produitScalaire == 1 * 4 + 2 * 5);
    }
}*/
//----------------------------------------------------------------------------------------------- 24
/*TEST_CASE("Iterateur operations", "[Iterateur]") {
    // Initialisation d'un vecteur pour le test
    Vecteur vec;
    vec.ajouter(1);
    vec.ajouter(2);
    vec.ajouter(3);

    SECTION("Accès aux éléments via l'itérateur") {
        Iterateur it = begin(vec);
        REQUIRE(*it == 1);
        ++it;
        REQUIRE(*it == 2);
        ++it;
